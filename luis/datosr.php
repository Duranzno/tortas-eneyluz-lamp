...
<body>
	...
	<center><form action="agregarr.php" method="post">
...
<?php
		...
		$sql="select id_ron, marca from ron";
...
?>
	...
	<form action="borrarr.php" method="post">
	<select name="id_ron">
<option value="">Seleccionar</option>
...
<div>
	<center><button class="button" style="vertical-align:middle"><span><a href="bienvenido.html">Home</a></span></button>
			...
			<button class="button active" style="vertical-align:middle"><span><a href="datosr.php">Ron</a></span></button>
